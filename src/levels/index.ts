 ...
 */
function deriveLevel(score: number, policy: LevelPolicy): BaseCredLevel | undefined {
 ...
 */
export function deriveEthosCredibilityLevel(score: number): BaseCredLevel | undefined {
 ...
 */
export function deriveBuilderLevel(score: number): BaseCredLevel | undefined {
 ...
 * Returns undefined if score is negative.
 */
export function deriveCreatorLevel(score: number): BaseCredLevel | undefined {
